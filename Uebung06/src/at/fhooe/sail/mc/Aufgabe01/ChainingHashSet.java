...
public class ChainingHashSet {
	...
	public int getOverflowCount(int hashVal) throws ValueException {
		...
		if (hashVal < 0 || hashVal >= this.array.length || this.array[hashVal] == null) {
			helpThrowing(hashVal);
		}
	...
	private void helpThrowing(int i) throws ValueException {
		throw new ValueException(i);
	}
}
