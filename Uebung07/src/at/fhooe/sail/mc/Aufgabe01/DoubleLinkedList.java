...
public class DoubleLinkedList<T extends Comparable<T>> {
	...
	/**
	 * Returns the element at position ‘index’. Throws exception if access is
	 * invalid.
	 */
	public T get(int index) {

		if (head == null || index < 0 || index > indexList) {
			return null;
		}
	...
	/**
	 * Removes and returns the front element of the linked list. Throws Exception if
	 * Access is invalid.
	 */
	public T popFront() {
	...
	/**
	 * Returns the front element of the list without removing it. Throws Exception
	 * if invalid Access.
	 */
	public T peekFront() {
	 ...
	 * Exception if Access is invalid.
	 */
	public T popBack() {
